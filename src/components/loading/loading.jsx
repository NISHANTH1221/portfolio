    ...
    return (
        <div className="loading">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" width="100" height="100">
                    <circle fill="white" stroke="#FF156D" stroke-width="15" r="15" cx="35" cy="100">
                    ...
                    <circle fill="white" stroke="#FF156D" stroke-width="15" opacity=".8" r="15" cx="35" cy="100">
                    ...
                    <circle fill="white" stroke="#FF156D" stroke-width="15" opacity=".6" r="15" cx="35" cy="100">
                    ...
                    <circle fill="white" stroke="#FF156D" stroke-width="15" opacity=".4" r="15" cx="35" cy="100">
                    ...
                    <circle fill="white" stroke="#FF156D" stroke-width="15" opacity=".2" r="15" cx="35" cy="100">
           ...
           <div>Loading Best Experience ...</div>
        </div>
    );
}
